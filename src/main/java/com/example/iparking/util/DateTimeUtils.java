...
public class DateTimeUtils {
	...
	public final static String MMM_D_YYYY_K_M_S_A = "MMM d, yyyy K:m:s a";
	 ...
	 * 计算时间数(精确到分钟)
	 */
	public static Map<String, Integer> calculateTimeDifference(String startTime, String endTime) throws ParseException {
	...
	public static Map<String, Integer> calcDiffTime(String startTime, String endTime) {
		try {
			...
			Map<String, Integer> map = new HashMap<>();
			map.put("days", Integer.valueOf(String.valueOf(days)));
			map.put("hours", Integer.valueOf(String.valueOf(hours)));
			map.put("minutes", Integer.valueOf(String.valueOf(minutes)));
			map.put("seconds", Integer.valueOf(String.valueOf(seconds)));
			return map;
		} catch (Exception e) {
			return null;
		}
...
//		DATE_REGEX_MAP.put("yyyy-MM-dd", "(([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|((0[48]|[2468][048]|[3579][26])00))-02-29)(([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|((0[48]|[2468][048]|[3579][26])00))-02-29)");
	...
	public static String getTimeToMM(Date date) {
		SimpleDateFormat dateFormat = new SimpleDateFormat(YYYY_MM_DD_HH_mm1);
		return dateFormat.format(date);
	}

	/**
	 * 该方法把传入的时间转化为"yyyy/MM/dd HH"格式的字符串
	 *
	 * @param date Date 时间对象
	 * @return String 传入时间的"yyyy/MM/dd HH"格式化字符串
	 */
	public static String getTimeToHH(Date date) {
		SimpleDateFormat dateFormat = new SimpleDateFormat(YYYY_MM_DD_HH1);
		return dateFormat.format(date);
	}

	public static String formatFullTime(LocalDateTime localDateTime) {
		return formatFullTime(localDateTime, dateTimeLongString);
	}
    ...
    public static Date getDateByParamter(Date date, int hour, int minute, int second) {
    ...
    public static Date getDateByParamter(Date date,int day, int hour, int minute, int second) {
    	Calendar cale = Calendar.getInstance();
		cale.setTime(date);
